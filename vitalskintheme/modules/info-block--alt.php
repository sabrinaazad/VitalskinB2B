<section class="section section--info-block--alt full-width">
    <div class="section-wrapper">
        <div class="left">
            <div class="image-wrapper main-image">
                <img src="<?php echo the_sub_field('info_blocks_alt_image_main'); ?>" alt="lifestyle image" width="435"
                    height="499">
            </div>
            <div class="image-wrapper overlap-image">
                <img src="<?php echo the_sub_field('info_blocks_alt_image_overlap'); ?>" alt="small image" width="147"
                    height="147">
            </div>
        </div>
        <div class="right">
            <span class="preheading"><?php echo the_sub_field('info_blocks_alt_preheading'); ?></span>
            <h2 class="white"><?php echo the_sub_field('info_blocks_alt_heading'); ?></h2>
            <p><?php echo the_sub_field('info_blocks_alt_p1'); ?></p>

            <?php 
			if( get_sub_field('info_blocks_alt_button_url') ): 
				if( get_sub_field('arrow_class') ) 
				{
					$arrow = "arrow";
				} else {
					$arrow = "";
			...
			?>
            <a href="<?php echo the_sub_field('info_blocks_alt_button_url'); ?>"
                class="btn btn-secondary white <?php echo $arrow ?> "><?php echo the_sub_field('info_blocks_alt_button_text'); ?></a>
            <?php endif; ?>

            <?php if( get_sub_field('info_blocks_alt_p2') ): ?>
            <p><?php echo the_sub_field('info_blocks_alt_p2'); ?></p>
            <?php endif; ?>
        </div>
    </div>
    <?php
